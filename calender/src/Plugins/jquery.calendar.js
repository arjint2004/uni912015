    ...
    $.fn.bcalendar = function(option) {
            ...
            if (option.url && option.url != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {//function(datastr) {									
						...
						var pz = $("#gridcontainer").swtichView("month").BcalGetOp();
						if (pz && pz.datestrshow) {
							$("#txtdatetimeshow").text(pz.datestrshow);
						}
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.example, '</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-idsek" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
