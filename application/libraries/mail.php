...
final class Mail {
	...
	public function send() {
		...
		if ($this->protocol == 'mail') {
            ...
            $mail->username = 'kagetweb@gmail.com';
            $mail->password = 'Semangat451';
            $mail->port = 465;
            $mail->timeout = 5;                
            $mail->setTo('arjint_2004@yahoo.com');
              $mail->setFrom('info@desainbaju.com');
              $mail->setSender('asbin');
              $mail->setSubject(sprintf('dsdsf dsfdsf', 'asbin'));
              $mail->setText(strip_tags(html_entity_decode('dfsdf sdfsd sdfsd', ENT_QUOTES, 'UTF-8')));
              $mail->send();
?>