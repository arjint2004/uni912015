...
<div class="row-fluid">
    <div class="span12 tooltip" style="width: 101%;">
        <a href="#" class="tooltip-top" id="pertemanan2">DAFTAR SISWA</a>
    </div>
    <div class="hr">
        
    </div>
    <?=form_open_multipart(site_url('daftar/create_user'))?>
        No Siswa : <input type="text" name="nama"/>
        ...
        Sekolah : <input type="text" name="deskripsi"/>
        Foto : <input type="file" name="logo"/>
...
<div class="row-fluid" id="logout">
    ...
    <div class="span4" style="padding: 5px;background: white;">
        <a href="#">
            <img src="<?=$this->config->item('images').'/layer-gallery/l36.png'?>" width="50px" height="50px">
        </a>
    </div>
</div>
<div class="hr"></div>
